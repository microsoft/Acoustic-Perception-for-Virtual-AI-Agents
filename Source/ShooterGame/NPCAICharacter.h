...
UCLASS(config=Game)
class ANPCAICharacter : public ACharacter
{
	GENERATED_BODY()
	...
	class UAcousticsSecondaryListener* AcousticsListener;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Acoustics, meta = (AllowPrivateAccess = "true"))
	class UAkComponent* AkListener;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Acoustics, meta = (AllowPrivateAccess = "true"))
	class UAcousticsAudioComponent* NpcGunSound;
